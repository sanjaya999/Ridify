...
function Upload() {
    ...
    // Hardcoded location coordinates (you can change these values)
    const [location, setLocation] = useState({
        latitude: 27.7172,   // Kathmandu, Nepal latitude
        longitude: 85.3240   // Kathmandu, Nepal longitude
    });

    // Removed the geolocation useEffect since we're using hardcoded values
    // useEffect(() => {
